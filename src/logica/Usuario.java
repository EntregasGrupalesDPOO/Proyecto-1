...
import Exepciones.TiqueteMultipleUENoExisteExcpetion;
import Exepciones.TiqueteMultipleVENoExisteExcpetion;
...
public abstract class Usuario {
	...
	public TiqueteMultiple comprarTiquetesMultiplesVE(HashMap<Evento,Integer> eventos, boolean usarSaldo) throws Exception{
		if(usarSaldo == true && this.saldoVirtual < TiqueteMultipleVariosEventos.calcularPrecioReal(eventos)) {
			...
			if (usarSaldo == true && this.saldoVirtual >= TiqueteMultipleVariosEventos.precios.get(eventos.size())) {
	...
	public ArrayList<Tiquete> comprarTiquetesDeluxe(int cantidad, Evento evento, Integer idLocalidad, boolean usarSaldo)throws Exception {
		...
		if (cantidad > Tiquete.tiquetesMax) {
			...
			if (usarSaldo == true && this.saldoVirtual >= TiqueteDeluxe.precio * cantidad) {
